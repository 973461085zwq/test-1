...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, "call$5", "async___rootCreateTimer$closure", 10, 0, 61, 0, 2, 1, 19, 16],
    _rootCreatePeriodicTimer: [function($self, $parent, zone, duration, callback) {
      return P.Timer__createPeriodicTimer(duration, C.C__RootZone !== zone ? zone.bindUnaryCallback$1(callback) : callback);
    }, "call$5", "async___rootCreatePeriodicTimer$closure", 10, 0, 62, 0, 2, 1, 19, 16],
    ...
    _ZoneDelegate: {
      ...
      registerBinaryCallback$2: [function(zone, f) {
        ...
        implZone = implementation.zone;
        return implementation.$function.call$4(implZone, P._parentDelegate(implZone), zone, f);
      }, "call$2", "get$registerBinaryCallback", 4, 0, 29],
    ...
    _CustomZone: {
      ...
      }, "call$1", "get$registerCallback", 2, 0, 18],
      ...
      static: {
        ...
        _Uri__makePath: function(path, start, end, pathSegments, scheme, hasAuthority) {
          ...
          if (t1)
            ...
            result = H.setRuntimeTypeInfo(new H.MappedListIterable(pathSegments, new P._Uri__makePath_closure()), [null, null]).join$1(0, "/");
          }
          if (result.length === 0) {
            if (isFile)
              return "/";
    ...
    _SimpleUri: {
      ...
      get$queryParameters: function() {
        if (!J.$lt$n(this._queryStart, this._fragmentStart))
          return C.Map_empty0;
        return H.setRuntimeTypeInfo(new P.UnmodifiableMapView(P.Uri_splitQueryString(this.get$query(this), C.Utf8Codec_false)), [P.String, P.String]);
      },
      ...
      _simpleMerge$2: function(base, ref) {
        var t1, t2, t3, t4, t5, t6, isSimple, delta, refStart, baseEnd, backCount, t7, insert;
        t1 = ref._schemeEnd;
        t2 = J.getInterceptor$n(t1);
        if (t2.$gt(t1, 0))
          return ref;
        ...
        if (t5.$eq(t4, baseEnd) && J.$gt$n(base._hostStart, 0)) {
          for (; t3.startsWith$2(t2, "../", refStart);)
            refStart = J.$add$ns(refStart, 3);
          delta = J.$add$ns(t5.$sub(t4, refStart), 1);
          return new P._SimpleUri(J.substring$2$s(base._uri, 0, t4) + "/" + t3.substring$1(t2, refStart), base._schemeEnd, base._hostStart, base._portStart, t4, J.$add$ns(t1, delta), J.$add$ns(ref._fragmentStart, delta), base._schemeCache, null);
        }
        t5 = base._uri;
        t6 = J.getInterceptor$s(t5);
        if (t6.startsWith$2(t5, "../", t4))
          return this._toNonSimple$0().resolveUri$1(ref);
        backCount = 1;
        while (true) {
          t7 = J.getInterceptor$ns(refStart);
          if (!(J.$le$n(t7.$add(refStart, 3), t1) && t3.startsWith$2(t2, "../", refStart)))
            break;
          refStart = t7.$add(refStart, 3);
          ++backCount;
        }
        for (insert = ""; t7 = J.getInterceptor$n(baseEnd), t7.$gt(baseEnd, t4);) {
          baseEnd = t7.$sub(baseEnd, 1);
          if (t6.codeUnitAt$1(t5, baseEnd) === 47) {
            --backCount;
            if (backCount === 0) {
              insert = "/";
              break;
        ...
        t7 = J.getInterceptor(baseEnd);
        if (t7.$eq(baseEnd, 0) && !t6.startsWith$2(t5, "/", t4))
          insert = "";
        delta = J.$add$ns(t7.$sub(baseEnd, refStart), insert.length);
        return new P._SimpleUri(t6.substring$2(t5, 0, baseEnd) + insert + t3.substring$1(t2, refStart), base._schemeEnd, base._hostStart, base._portStart, t4, J.$add$ns(t1, delta), J.$add$ns(ref._fragmentStart, delta), base._schemeCache, null);
      },
      toFilePath$1$windows: function(windows) {
        var t1, t2, t3, t4;
        t1 = this._schemeEnd;
    ...
    _GuaranteeSink: {
      "^": "Object;_guarantee_channel$_inner,_channel,_doneCompleter,_disconnected,_closed,_addStreamSubscription,_addStreamCompleter,_allowErrors",
      add$1: function(_, data) {
        var t1;
        if (this._closed)
    ...
    _connectToServer: function() {
      ...
      webSocket = W.WebSocket_WebSocket(P.Uri_parse(window.location.href, 0, null).get$queryParameters().$index(0, "managerUrl"), null);
      controller = B.StreamChannelController$(true, true, null);
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new M._connectToServer_closure(controller)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    ...
    _connectToIframe: function(url, id) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new M._connectToIframe_closure(iframe, controller, readyCompleter)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = controller._local._streamController;
      t1.toString;
    ...
    main_closure: {
      ...
      call$0: [function() {
        ...
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new M.main__closure1(serverChannel)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
...
;
  ...
  C.Map_empty0 = H.setRuntimeTypeInfo(new H.ConstantStringMap(0, {}, C.List_empty), [P.String, P.String]);
  ...
  $ = new Isolate();
  init.metadata = ["self", "zone", "parent", "error", "stackTrace", null, "_", "message", "f", "value", "line", "frame", "arg", "trace", "data", "result", "callback", "key", "each", "duration", "arg2", "arg1", "element", "x", "object", "arg4", "arg3", "specification", "zoneValues", "arguments", "isolate", "errorCode", "closure", "k", "v", 0, "numberOfArguments", "encodedComponent", "s", "e", "sender"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: {func: 1, args: [,]}, args: [{func: 1, args: [,]}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.Timer, args: [P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.$int]}, {func: 1, ret: P.Timer, args: [P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.AsyncError, args: [P.Object, P.StackTrace]}, {func: 1, ret: {func: 1, args: [,,]}, args: [{func: 1, args: [,,]}]}, {func: 1, ret: {func: 1}, args: [{func: 1}]}, {func: 1, args: [{func: 1, args: [,,]},,,]}, {func: 1, args: [{func: 1, args: [,]},,]}, {func: 1, args: [{func: 1}]}, {func: 1, ret: P.Zone, named: {specification: P.ZoneSpecification, zoneValues: P.Map}}, {func: 1, v: true, args: [P.Zone, {func: 1}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, args: [, P.String]}, {func: 1, ret: {func: 1, args: [,,]}, args: [P.Zone, {func: 1, args: [,,]}]}, {func: 1, ret: {func: 1, args: [,]}, args: [P.Zone, {func: 1, args: [,]}]}, {func: 1, ret: {func: 1}, args: [P.Zone, {func: 1}]}, {func: 1, args: [P.Zone, {func: 1, args: [,,]},,,]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.Object, P.StackTrace]}, {func: 1, args: [P.Zone, {func: 1, args: [,]},,]}, {func: 1, args: [P.Zone, {func: 1}]}, {func: 1, args: [P.String]}, {func: 1, args: [P.Zone,, P.StackTrace]}, {func: 1, args: [P.bool]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [P.String,,]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, v: true, args: [P.$int, P.$int]}, {func: 1, ret: P.num, args: [P.num, P.num]}, {func: 1, v: true, opt: [,]}, {func: 1, v: true, args: [P.String, P.$int]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, args: [P.$int,,]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, v: true, args: [,]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1}]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, args: [,]},,]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, args: [,,]},,,]}, {func: 1, ret: {func: 1}, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1}]}, {func: 1, ret: {func: 1, args: [,]}, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, args: [,]}]}, {func: 1, ret: {func: 1, args: [,,]}, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, args: [,,]}]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, args: [P.Symbol,,]}];
